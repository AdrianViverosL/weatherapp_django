...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=49C73066-2623-4FFC-95D2-85984CBADBA0")
        ...
        if api[0]['Category']['Name'] == "Good" :
            ...
            category_description = "(51 - 100) Air Quality is acceptable; however, for some pollutans there may be a moderate health concern for a very small number of people who are unusually sensitive to air pollution."
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=49C73066-2623-4FFC-95D2-85984CBADBA0")
